...
if(!isset($_GET['school_id']))
	exit(json_encode(array("successful" => false, "error" => "school_id is not provided.")));

if(!validSchoolId($_GET['school_id']))
	exit(json_encode(array("successful" => false, "error" => "school_id was not valid.")));

$posts = getPosts($_GET['school_id']);
