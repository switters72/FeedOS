...
public class WebServicesController {
    ...
    private static boolean emailConfirmation;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int index = 0; index < jsonArray.length(); index++) {
                                ...
                                Post post = new Post(parsedID, parsedOwnerID, parsedSchoolID, parsedDateUtc, parsedContent, parsedCommentCount, parsedVoteCount);
                                posts.add(post);
                            }
    ...
    public static void loadComments(Context context){
        ...
        String url ="https://anonymousuniversity.com/api/set/users.php?email=" + emailConfirmation;
        // Request a string response from the provided URL.
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
